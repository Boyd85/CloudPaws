function CalendarApp(date) {
  ...
  this.quotes = ['No Appointments today.'];
  this.apts = [
    {
  ...
  this.dayInspirationalQuote = document.getElementById("day-holder");
...
CalendarApp.prototype.openDayWindow = function(date){
  ...
  this.dayEventsEle.textContent = _dayTopbarText + "appointments on " + this.months[day.getMonth()] + " " + day.getDate() + ", " + day.getFullYear();
